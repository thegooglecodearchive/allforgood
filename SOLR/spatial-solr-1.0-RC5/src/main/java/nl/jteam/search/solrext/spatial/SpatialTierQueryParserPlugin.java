  ...
  private class SpatialTierQParser extends QParser {
    ...
    public SpatialTierQParser(String queryString, SolrParams localParams, SolrParams params, SolrQueryRequest request) {
      ...
      try {
        ...
        System.out.println(preConstructedQuery.toString());
      ...
      localbf = localParams.getParams("boost");
    ...
    /** {@inheritDoc} */ // added by superk
    public Query parse() throws ParseException {
      BooleanQuery bq = new BooleanQuery(true); // disable coord because this is an artificial construct

      Query filtered = new FilteredQuery(preConstructedQuery, spatialFilter);
      bq.add(filtered, BooleanClause.Occur.MUST);
      addBoostFunctions(bq, localbf);
      return bq;
    }

    // added by superk
    protected void addBoostFunctions(BooleanQuery query, String[] localbf) throws ParseException {
      String[] boostFuncs = localbf;
